...
namespace ERP_Mensajeria.Controllers
{
    public class ContactosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Contacto,Nombre,CUI,Correo,Gafete")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Contacto,Nombre,CUI,Correo,Gafete")] Contacto contacto)
        {
            if (ModelState.IsValid)
            {
